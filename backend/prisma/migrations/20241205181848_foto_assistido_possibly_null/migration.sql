...
INSERT INTO "new_Assistido" ("ativo", "data_nascimento", "descricao", "estado_civil", "existe_contato", "familiar_proximo", "filhos", "foto", "id", "motivo_saiu", "nome", "sexo", "situacao", "usuarioId") SELECT "ativo", "data_nascimento", "descricao", "estado_civil", "existe_contato", "familiar_proximo", "filhos", "foto", "id", "motivo_saiu", "nome", "sexo", "situacao", "usuarioId" FROM "Assistido";
